...
- Blackbox builds Gemini, Tavily, and composite search
...
Use Gemini through LangChain4j, support Tavily, and keep fallback behavior safe when API keys are missing.
