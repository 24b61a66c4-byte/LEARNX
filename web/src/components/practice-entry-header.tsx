      ...
      <div className="grid gap-6 lg:grid-cols-[1fr_auto] lg:items-end">
        <div className="space-y-4">
          ...
          <p className="max-w-2xl text-sm leading-7 text-slate-600 sm:text-base">
            Score one drill, read the misses, and send the weak points back into notes or the tutor. Keep the session
            focused on {subjectName} so the context never resets.
          </p>
        </div>
        ...
        <div className="surface-panel min-w-full max-w-sm p-4 lg:min-w-[18rem]">
          ...
          <div className="mt-4 grid gap-3">
            <div className="rounded-[20px] bg-white/84 px-4 py-4 shadow-sm">
              ...
              <p className="mt-2 text-lg font-semibold text-slate-950">Mixed MCQ + text</p>
            </div>
            <div className="rounded-[20px] bg-white/84 px-4 py-4 shadow-sm">
            ...
            <div className="rounded-[20px] bg-white/84 px-4 py-4 shadow-sm">
              ...
              <p className="mt-2 text-lg font-semibold text-slate-950">Tutor review next</p>
            </div>
          </div>
        </div>
      </div>
