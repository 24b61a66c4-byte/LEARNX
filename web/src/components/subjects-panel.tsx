      ...
      <div className="grid gap-6 xl:grid-cols-[1.1fr_0.9fr]">
        <div className="surface-card overflow-hidden p-6 backdrop-blur-xl">
          <div className={`rounded-[28px] bg-gradient-to-br ${preferredSubject.accent} p-6`}>
            ...
            <h1 className="mt-2 text-4xl font-bold tracking-tight text-slate-950 bg-gradient-to-r bg-clip-text text-transparent from-slate-950 to-slate-800">Pick your study subject</h1>
            <p className="mt-3 max-w-3xl text-sm leading-7 text-slate-700">
              Choose one subject, study one topic, then do a short quiz.
            </p>
          </div>
          <div className="mt-6">
            <p className="text-sm font-semibold text-slate-600">Current focus</p>
        ...
        <div className="surface-panel p-6">
          ...
          <h2 className="mt-2 text-2xl font-bold tracking-tight text-slate-950">
            {preferredSubject.name}: {continueTopic?.title ?? "start here"}
          </h2>
